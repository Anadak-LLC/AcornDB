...
namespace AcornDB.Sync
{
    ...
    public class SyncEngine
    {
        ...
        {
            AcornLog.Info($">> [Acorn.Sync] Pushing local nutments to {_remoteEndpoint}...");
        ...
        {
            AcornLog.Info($">> [Acorn.Sync] Pulling latest nutment stash from {_remoteEndpoint}...");
        ...
        {
            AcornLog.Info($">> [Acorn.Sync] Full nut shake: two-way sync initiated.");
